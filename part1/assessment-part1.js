...
String.prototype.grammarPolice = function(){
  return this.split(" ")
  .map(word => word[0].toLocaleUpperCase() + word.slice(1).toLowerCase()).join(" ");
}
...
function promiseCatcher (pam) {
  pam.then(response => (theAnswer = response));
}